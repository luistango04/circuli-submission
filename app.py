...
def upload_file():
    if request.method == 'POST':
        ...
        if None not in uploaded_files.values():
            ...
            pointcloudvisual = displaypointclouds(file_container.annotated_point_cloud)
            ...
            return render_template('display.html', image=imagetoshow, json_data=jsondumpsprepare, htmlcontent=pointcloudvisual)  # Pass image to the template
